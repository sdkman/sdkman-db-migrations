...
class Migrations {
  ...
  def migrate001(db: MongoDatabase) = db.getCollection("versions").insertMany(List[Document](
    ...
    Version("java", "9.0.4-zulu", "https://cdn.azul.com/zulu/bin/zulu9.0.4.1-jdk9.0.4-win_x64.zip", Windows)).asJava)
  ...
  def migrate002(db: MongoDatabase) = db.getCollection("versions").insertOne(
    Version("java", "9.0.4-zulu", "https://cdn.azul.com/zulu/bin/zulu9.0.4.1-jdk9.0.4-linux_x64.tar.gz", Linux))

  @ChangeSet(order = "003", id = "003-add_openjdk_latest", author = "MaSven")
  def migrate003(implicit db: MongoDatabase) = insertVersions(
    Version("java", "9u181-openjdk", "https://github.com/AdoptOpenJDK/openjdk9-releases/releases/download/jdk-9%2B181/OpenJDK9_x64_Linux_jdk-9.181.tar.gz", Linux),
    ...
    Version("java", "8u144-openjdk", "https://github.com/AdoptOpenJDK/openjdk8-releases/releases/download/jdk8u144-b01/OpenJDK8_x64_Linux_jdk8u144-b01.tar.gz", Linux),
    ...
    Version("java", "10u23-openjdk", "https://github.com/AdoptOpenJDK/openjdk10-releases/releases/download/jdk-10%2B23/OpenJDK10_x64_Linux_jdk-10.23.tar.gz", Linux),
  ...
  def migrate006(implicit db: MongoDatabase) = {
    insertVersions(Version("maven", "3.5.3", "https://archive.apache.org/dist/maven/maven-3/3.5.3/binaries/apache-maven-3.5.3-bin.zip"))
