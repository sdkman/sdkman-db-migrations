...
class CxfMigrations {
  ...
  def migration002(implicit db: MongoDatabase) = {
    ...
    Version("cxf", "3.2.4", "https://archive.apache.org/dist/cxf/3.2.4/apache-cxf-3.2.4.zip").validate().insert()
    Version("cxf", "3.2.5", "https://archive.apache.org/dist/cxf/3.2.5/apache-cxf-3.2.5.zip").validate().insert()
  }
