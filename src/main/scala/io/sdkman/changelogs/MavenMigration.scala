...
class MavenMigration {
  ...
  @ChangeSet(order = "003", id = "003-add_maven_3.6.1", author = "philiplourandos")
  def migration003(implicit db: MongoDatabase) = {
    Version("maven", "3.6.1", "https://archive.apache.org/dist/maven/maven-3/3.6.1/binaries/apache-maven-3.6.1-bin.zip")
      .validate()
      .insert()
      .asCandidateDefault()
  }  
  ...
  def migration004(implicit db: MongoDatabase) = {
    Version("maven", "3.6.2", "https://archive.apache.org/dist/maven/maven-3/3.6.2/binaries/apache-maven-3.6.2-bin.zip")
      .validate()
      .insert()
      .asCandidateDefault()
  }

  @ChangeSet(order = "005", id = "005-add_maven_3.6.3", author = "philiplourandos")
  def migration005(implicit db: MongoDatabase) = {
    Version("maven", "3.6.3", "https://www-us.apache.org/dist/maven/maven-3/3.6.3/binaries/apache-maven-3.6.3-bin.zip")
      .validate()
      .insert()
      .asCandidateDefault()
  }
