...
class JavaMigrations {
  ...
  def migrate187(implicit db: MongoDatabase) = {
    ...
    List(
      Version("java", "13.0.0-open", "https://download.java.net/java/GA/jdk13/5b8a42f3905b406298b72d750b6919f6/33/GPL/openjdk-13_linux-x64_bin.tar.gz", Linux64, Some(OpenJDK)),
      Version("java", "13.0.0-open", "https://download.java.net/java/GA/jdk13/5b8a42f3905b406298b72d750b6919f6/33/GPL/openjdk-13_osx-x64_bin.tar.gz", MacOSX, Some(OpenJDK)),
      Version("java", "13.0.0-open", "https://download.java.net/java/GA/jdk13/5b8a42f3905b406298b72d750b6919f6/33/GPL/openjdk-13_windows-x64_bin.zip", Windows, Some(OpenJDK)))
      .validate()
      .insert()
  }
}
